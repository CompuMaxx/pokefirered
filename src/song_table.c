...
const struct Song gSongTable[] = 
{
    ...
    {(struct SongHeader*)&se_rs_door, 1, 1},
    ...
    {(struct SongHeader*)&se_rs_shop, 1, 1},
    ...
    {(struct SongHeader*)&se_card_flip, 1, 1},
    {(struct SongHeader*)&se_card_flipping, 1, 1},
    {(struct SongHeader*)&se_card_open, 1, 1},
    {(struct SongHeader*)&se_bag_cursor, 1, 1},
    {(struct SongHeader*)&se_bag_pocket, 1, 1},
    {(struct SongHeader*)&se_ball_click, 1, 1},
    {(struct SongHeader*)&se_shop, 1, 1},
    {(struct SongHeader*)&se_ss_anne_horn, 1, 1},
    {(struct SongHeader*)&se_help_open, 1, 1},
    {(struct SongHeader*)&se_help_close, 1, 1},
    {(struct SongHeader*)&se_help_error, 1, 1},
    {(struct SongHeader*)&se_deoxys_move, 1, 1},
    {(struct SongHeader*)&se_poke_jump_success, 1, 1},
    {(struct SongHeader*)&se_poke_jump_failure, 1, 1},
    ...
    {(struct SongHeader*)&mus_rs_vs_gym_leader, 0, 0},
    {(struct SongHeader*)&mus_rs_vs_trainer, 0, 0},
    ...
    {(struct SongHeader*)&mus_rocket_hideout, 0, 0},
    {(struct SongHeader*)&mus_gym, 0, 0},
    {(struct SongHeader*)&mus_jigglypuff, 2, 2},
    {(struct SongHeader*)&mus_intro_fight, 0, 0},
    {(struct SongHeader*)&mus_title, 0, 0},
    {(struct SongHeader*)&mus_cinnabar, 0, 0},
    {(struct SongHeader*)&mus_lavender, 0, 0},
    {(struct SongHeader*)&mus_heal_unused, 0, 0},
    {(struct SongHeader*)&mus_cycling, 0, 0},
    {(struct SongHeader*)&mus_encounter_rocket, 0, 0},
    {(struct SongHeader*)&mus_encounter_girl, 0, 0},
    {(struct SongHeader*)&mus_encounter_boy, 0, 0},
    {(struct SongHeader*)&mus_hall_of_fame, 0, 0},
    {(struct SongHeader*)&mus_viridian_forest, 0, 0},
    {(struct SongHeader*)&mus_mt_moon, 0, 0},
    {(struct SongHeader*)&mus_poke_mansion, 0, 0},
    {(struct SongHeader*)&mus_credits, 0, 0},
    {(struct SongHeader*)&mus_route1, 0, 0},
    {(struct SongHeader*)&mus_route24, 0, 0},
    {(struct SongHeader*)&mus_route3, 0, 0},
    {(struct SongHeader*)&mus_route11, 0, 0},
    ...
    {(struct SongHeader*)&mus_pallet, 0, 0},
    {(struct SongHeader*)&mus_oak_lab, 0, 0},
    {(struct SongHeader*)&mus_oak, 0, 0},
    {(struct SongHeader*)&mus_poke_center, 0, 0},
    {(struct SongHeader*)&mus_ss_anne, 0, 0},
    {(struct SongHeader*)&mus_surf, 0, 0},
    {(struct SongHeader*)&mus_poke_tower, 0, 0},
    {(struct SongHeader*)&mus_silph, 0, 0},
    {(struct SongHeader*)&mus_fuchsia, 0, 0},
    {(struct SongHeader*)&mus_celadon, 0, 0},
    ...
    {(struct SongHeader*)&mus_vermillion, 0, 0},
    {(struct SongHeader*)&mus_pewter, 0, 0},
    {(struct SongHeader*)&mus_encounter_rival, 0, 0},
    {(struct SongHeader*)&mus_rival_exit, 0, 0},
    {(struct SongHeader*)&mus_dex_rating, 2, 2},
    {(struct SongHeader*)&mus_obtain_key_item, 2, 2},
    {(struct SongHeader*)&mus_caught_intro, 2, 2},
    {(struct SongHeader*)&mus_photo, 2, 2},
    {(struct SongHeader*)&mus_game_freak, 0, 0},
    {(struct SongHeader*)&mus_caught, 0, 0},
    {(struct SongHeader*)&mus_new_game_instruct, 0, 0},
    {(struct SongHeader*)&mus_new_game_intro, 0, 0},
    {(struct SongHeader*)&mus_new_game_exit, 0, 0},
    {(struct SongHeader*)&mus_poke_jump, 0, 0},
    {(struct SongHeader*)&mus_union_room, 0, 0},
    {(struct SongHeader*)&mus_net_center, 0, 0},
    {(struct SongHeader*)&mus_mystery_gift, 0, 0},
    {(struct SongHeader*)&mus_berry_pick, 0, 0},
    {(struct SongHeader*)&mus_sevii_cave, 0, 0},
    {(struct SongHeader*)&mus_teachy_tv_show, 0, 0},
    {(struct SongHeader*)&mus_sevii_route, 0, 0},
    {(struct SongHeader*)&mus_sevii_dungeon, 0, 0},
    {(struct SongHeader*)&mus_sevii_123, 0, 0},
    {(struct SongHeader*)&mus_sevii_45, 0, 0},
    {(struct SongHeader*)&mus_sevii_67, 0, 0},
    {(struct SongHeader*)&mus_poke_flute, 2, 2},
    {(struct SongHeader*)&mus_vs_deoxys, 0, 0},
    {(struct SongHeader*)&mus_vs_mewtwo, 0, 0},
    {(struct SongHeader*)&mus_vs_legend, 0, 0},
    {(struct SongHeader*)&mus_encounter_gym_leader, 0, 0},
    {(struct SongHeader*)&mus_encounter_deoxys, 0, 0},
    {(struct SongHeader*)&mus_trainer_tower, 0, 0},
    {(struct SongHeader*)&mus_slow_pallet, 0, 0},
    {(struct SongHeader*)&mus_teachy_tv_menu, 0, 0}
};
