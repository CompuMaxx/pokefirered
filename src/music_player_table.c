...
{
    {&gMPlayInfo_BGM, gMPlayTrack_BGM, NUM_TRACKS_BGM, 0},
    {&gMPlayInfo_SE1, gMPlayTrack_SE1, NUM_TRACKS_SE1, 1},
    {&gMPlayInfo_SE2, gMPlayTrack_SE2, NUM_TRACKS_SE2, 1},
    {&gMPlayInfo_SE3, gMPlayTrack_SE3, NUM_TRACKS_SE3, 0}
};
