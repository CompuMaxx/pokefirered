...
$(MID_SUBDIR)/mus_bw_accumula_town.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_ROOM) -V090
...
$(MID_SUBDIR)/mus_hall_of_fame.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V079
...
$(MID_SUBDIR)/mus_dex_rating.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V070 -P5

$(MID_SUBDIR)/mus_obtain_key_item.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V077 -P5
...
$(MID_SUBDIR)/mus_oak_lab.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V075
...
$(MID_SUBDIR)/mus_route3.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V083
...
$(MID_SUBDIR)/mus_school.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V100 -P1
...
$(MID_SUBDIR)/mus_poke_flute.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V048 -P5

$(MID_SUBDIR)/mus_poke_mansion.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V090

$(MID_SUBDIR)/mus_jigglypuff.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V068 -P5
...
$(MID_SUBDIR)/mus_new_game_exit.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V088
...
$(MID_SUBDIR)/mus_silph.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V076

$(MID_SUBDIR)/mus_encounter_girl.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V051
...
$(MID_SUBDIR)/mus_slow_pallet.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V092

$(MID_SUBDIR)/mus_new_game_instruct.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V085
...
$(MID_SUBDIR)/mus_celadon.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V070
...
$(MID_SUBDIR)/mus_teachy_tv_menu.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V059
...
$(MID_SUBDIR)/mus_victory_trainer.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(UVG_STD) -V089
