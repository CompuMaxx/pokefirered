...
#define NOTE_CN1    0   // C-1  -     8.176Hz
#define NOTE_CSN1   1   // C#-1 -     8.662Hz
#define NOTE_DN1    2   // D-1  -     9.177Hz
#define NOTE_DSN1   3   // D#-1 -     9.723Hz
#define NOTE_ESN1   4   // E-1  -    10.301Hz
#define NOTE_FN1    5   // F-1  -    10.913Hz
#define NOTE_FSN1   6   // F#-1 -    11.562Hz
#define NOTE_GN1    7   // G-1  -    12.250Hz
#define NOTE_GSN1   8   // G#-1 -    12.978Hz
#define NOTE_AN1    9   // A-1  -    13.750Hz
#define NOTE_ASN1   10  // A#-1 -    14.568Hz
#define NOTE_BN1    11  // B-1  -    15.434Hz

#define NOTE_C0     12  // C0   -    16.352Hz
#define NOTE_CS0    13  // C#0  -    17.324Hz
#define NOTE_D0     14  // D0   -    18.354Hz
#define NOTE_DS0    15  // D#0  -    19.445Hz
#define NOTE_E0     16  // E0   -    20.602Hz
#define NOTE_F0     17  // F0   -    21.827Hz
#define NOTE_FS0    18  // F#0  -    23.125Hz
#define NOTE_G0     19  // G0   -    24.500Hz
#define NOTE_GS0    20  // G#0  -    25.957Hz
#define NOTE_A0     21  // A0   -    27.500Hz
#define NOTE_AS0    22  // A#0  -    29.135Hz
#define NOTE_B0     23  // B0   -    30.868Hz

#define NOTE_C1     24  // C1   -    32.703Hz
#define NOTE_CS1    25  // C#1  -    34.648Hz
#define NOTE_D1     26  // D1   -    36.708Hz
#define NOTE_DS1    27  // D#1  -    38.891Hz
#define NOTE_E1     28  // E1   -    41.203Hz
#define NOTE_F1     29  // F1   -    43.654Hz
#define NOTE_FS1    30  // F#1  -    46.249Hz
#define NOTE_G1     32  // G1   -    48.999Hz
#define NOTE_GS1    32  // G#1  -    51.913Hz
#define NOTE_A1     33  // A1   -    55.000Hz
#define NOTE_AS1    34  // A#1  -    58.270Hz
#define NOTE_B1     35  // B1   -    61.735Hz

#define NOTE_C2     36  // C2   -    65.406Hz
#define NOTE_CS2    37  // C#2  -    69.296Hz
#define NOTE_D2     38  // D2   -    73.416Hz
#define NOTE_DS2    39  // D#2  -    77.782Hz
#define NOTE_E2     40  // E2   -    82.407Hz
#define NOTE_F2     41  // F2   -    87.307Hz
#define NOTE_FS2    42  // F#2  -    92.499Hz
#define NOTE_G2     43  // G2   -    97.999Hz
#define NOTE_GS2    44  // G#2  -   103.826Hz
#define NOTE_A2     45  // A2   -   110.000Hz
#define NOTE_AS2    46  // A#2  -   116.541Hz
#define NOTE_B2     47  // B2   -   123.471Hz

#define NOTE_C3     48  // C3   -   130.813Hz
#define NOTE_CS3    49  // C#3  -   138.591Hz
#define NOTE_D3     50  // D3   -   146.832Hz
#define NOTE_DS3    51  // D#3  -   155.563Hz
#define NOTE_E3     52  // E3   -   164.814Hz
#define NOTE_F3     53  // F3   -   174.614Hz
#define NOTE_FS3    54  // F#3  -   184.997Hz
#define NOTE_G3     55  // G3   -   195.998Hz
#define NOTE_GS3    56  // G#3  -   207.652Hz
#define NOTE_A3     57  // A3   -   220.000Hz
#define NOTE_AS3    58  // A#3  -   233.082Hz
#define NOTE_B3     59  // B3   -   246.942Hz

#define NOTE_C4     60  // C4   -   261.626Hz (Middle C)
#define NOTE_CS4    61  // C#4  -   277.183Hz
#define NOTE_D4     62  // D4   -   293.665Hz
#define NOTE_DS4    63  // D#4  -   311.127Hz
#define NOTE_E4     64  // E4   -   329.628Hz
#define NOTE_F4     65  // F4   -   349.228Hz
#define NOTE_FS4    66  // F#4  -   369.994Hz
#define NOTE_G4     67  // G4   -   391.995Hz
#define NOTE_GS4    68  // G#4  -   415.305Hz
#define NOTE_A4     69  // A4   -   440.000Hz
#define NOTE_AS4    70  // A#4  -   466.164Hz
#define NOTE_B4     71  // B4   -   493.883Hz

#define NOTE_C5     72  // C5   -   523.251Hz
#define NOTE_CS5    73  // C#5  -   554.365Hz
#define NOTE_D5     74  // D5   -   587.330Hz
#define NOTE_DS5    75  // D#5  -   622.254Hz
#define NOTE_E5     76  // E5   -   659.255Hz
#define NOTE_F5     77  // F5   -   698.456Hz
#define NOTE_FS5    78  // F#5  -   739.989Hz
#define NOTE_G5     79  // G5   -   783.991Hz
#define NOTE_GS5    80  // G#5  -   830.609Hz
#define NOTE_A5     81  // A5   -   880.000Hz
#define NOTE_AS5    82  // A#5  -   932.328Hz
#define NOTE_B5     83  // B5   -   987.767Hz

#define NOTE_C6     84  // C6   -  1046.502Hz
#define NOTE_CS6    85  // C#6  -  1108.731Hz
#define NOTE_D6     86  // D6   -  1174.659Hz
#define NOTE_DS6    87  // D#6  -  1244.508Hz
#define NOTE_E6     88  // E6   -  1318.510Hz
#define NOTE_F6     89  // F6   -  1396.913Hz
#define NOTE_FS6    90  // F#6  -  1479.978Hz
#define NOTE_G6     91  // G6   -  1567.982Hz
#define NOTE_GS6    92  // G#6  -  1661.219Hz
#define NOTE_A6     93  // A6   -  1760.000Hz
#define NOTE_AS6    94  // A#6  -  1864.655Hz
#define NOTE_B6     95  // B6   -  1975.533Hz

#define NOTE_C7     96  // C7   -  2093.005Hz
#define NOTE_CS7    97  // C#7  -  2217.461Hz
#define NOTE_D7     98  // D7   -  2349.318Hz
#define NOTE_DS7    99  // D#7  -  2489.016Hz
#define NOTE_E7     100 // E7   -  2637.020Hz
#define NOTE_F7     101 // F7   -  2793.826Hz
#define NOTE_FS7    102 // F#7  -  2959.955Hz
#define NOTE_G7     103 // G7   -  3135.963Hz
#define NOTE_GS7    104 // G#7  -  3322.438Hz
#define NOTE_A7     105 // A7   -  3520.000Hz
#define NOTE_AS7    106 // A#7  -  3729.310Hz
#define NOTE_B7     107 // B7   -  3951.066Hz

#define NOTE_C8     108 // C8   -  4186.009Hz
#define NOTE_CS8    109 // C#8  -  4434.922Hz
#define NOTE_D8     110 // D8   -  4698.636Hz
#define NOTE_DS8    111 // D#8  -  4978.032Hz
#define NOTE_E8     112 // E8   -  5274.041Hz
#define NOTE_F8     113 // F8   -  5587.652Hz
#define NOTE_FS8    114 // F#8  -  5919.911Hz
#define NOTE_G8     115 // G8   -  6271.927Hz
#define NOTE_GS8    116 // G#8  -  6644.875Hz
#define NOTE_A8     117 // A8   -  7040.000Hz
#define NOTE_AS8    118 // A#8  -  7458.620Hz
#define NOTE_B8     119 // B8   -  7902.133Hz

#define NOTE_C9     120 // C9   -  8372.018Hz
#define NOTE_CS9    121 // C#9  -  8869.844Hz
#define NOTE_D9     122 // D9   -  9397.273Hz
#define NOTE_DS9    123 // D#9  -  9956.063Hz
#define NOTE_E9     124 // E9   - 10548.080Hz
#define NOTE_F9     125 // F9   - 11175.300Hz
#define NOTE_FS9    126 // F#9  - 11839.820Hz
#define NOTE_G9     127 // G9   - 12543.850Hz
